...
<qgis version="2.14.22-Essen" minimumScale="0" maximumScale="100001" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 attr="water" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="ditch" label="溝"/>
      <category render="true" symbol="1" value="drain" label="排水溝"/>
      <category render="true" symbol="2" value="river" label="河川"/>
      <category render="true" symbol="3" value="stream" label="支流"/>
      <category render="true" symbol="4" value="canal" label="運河"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="65,24,186,255"/>
          <prop k="line_style" v="solid"/>
