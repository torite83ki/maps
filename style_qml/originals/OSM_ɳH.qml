...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="type" symbollevels="0" type="categorizedSymbol">
    <categories>
      ...
      <category symbol="1" value="abandoned" label="廃線（線路の無いもの）"/>
      <category symbol="2" value="construction" label="工事中の線路"/>
      <category symbol="3" value="disused" label="休止線（線路のあるもの）"/>
      <category symbol="4" value="funicular" label="ケーブルカー"/>
      <category symbol="5" value="monorail" label="モノレール"/>
      <category symbol="6" value="platform" label="プラットフォーム"/>
      <category symbol="7" value="preserved" label="観光鉄道"/>
      <category symbol="8" value="rail" label="鉄道"/>
      <category symbol="9" value="subway" label="地下鉄"/>
      <category symbol="10" value="tram" label="路面電車"/>
    </categories>
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="161,92,88,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="case&#xa; WHEN &quot;type&quot; IS  'abandoned'  THEN ''&#xa; When &quot;type&quot; IS   'construction'  then '工事中' &#xa; When &quot;type&quot; IS    'disused'  then ''&#xa; else name&#xa;END"/>
  ...
  <displayfield>TK_ID</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="JOTAI"/>
    <edittype labelontop="0" editable="1" type="0" name="NAMAE"/>
    <edittype labelontop="0" editable="1" type="0" name="NODEID1"/>
    <edittype labelontop="0" editable="1" type="0" name="NODEID2"/>
    <edittype labelontop="0" editable="1" type="0" name="REFERENCE"/>
    <edittype labelontop="0" editable="1" type="0" name="SHUBETSU"/>
    <edittype labelontop="0" editable="1" type="0" name="TK_ID"/>
