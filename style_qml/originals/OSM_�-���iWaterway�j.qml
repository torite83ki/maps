...
<qgis version="2.2.0-Valmiera" minimumScale="0" maximumScale="100001" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="ditch" label="溝"/>
      <category symbol="1" value="drain" label="排水溝"/>
      <category symbol="2" value="river" label="河川"/>
      <category symbol="3" value="stream" label="支流"/>
      <category symbol="4" value="canal" label="運河"/>
    </categories>
    <symbols>
