...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/MaxScale" value="1~~1~~CASE&#xa;        WHEN &quot;type&quot; IS 'city' THEN 1000001&#xa;        WHEN &quot;type&quot; IS 'town' THEN 1000001&#xa;        WHEN &quot;type&quot; IS 'village' THEN 1000001&#xa;        WHEN &quot;type&quot; IS 'county' THEN 1000001&#xa;&#xa;        else 50001&#xa;END~~"/>
    <property key="labeling/dataDefined/Size" value="1~~1~~CASE&#xa;        WHEN &quot;type&quot; IS 'city' THEN 10&#xa;        WHEN &quot;type&quot; IS 'town' THEN 10&#xa;        WHEN &quot;type&quot; IS 'village' THEN 10&#xa;        WHEN &quot;type&quot; IS 'county' THEN 12&#xa;&#xa;        else 8&#xa;END~~"/>
